...
public class GameController : MonoBehaviour
{
	...
	public void Awake()
	{
		//if (MainParameters.Instance == null)
		//	Instantiate (mainParameters);
    ...
    private IEnumerator InitializeCoroutine()
    {
		...
		Generator.UpdateTerrain(Player.position,mainParameters.Radius);
	...
	public void ReStart()
	{
		...
		Player.position=new Vector3(Player.position.x,Player.position.y+100f,Player.position.z);
		Generator.ReStart ();
		StartAll ();
